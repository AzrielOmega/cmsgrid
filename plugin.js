	     	...
	     	exec: function(editor) {
		    	...
		    	if ($elem != null) {
				    ...
				    if ($thisrow.find("div[class^='col-']").length == 2) { // Only two column layouts
					    if ($thisrow.find(".col-sm-10:nth-child(1)").length) {
						    $thisrow.find(".col-sm-10").removeClass("col-sm-10").addClass("col-sm-9");
							$thisrow.find(".col-sm-2").removeClass("col-sm-2").addClass("col-sm-3");
							return;
						};
						if ($thisrow.find(".col-sm-9:nth-child(1)").length) {
						    $thisrow.find(".col-sm-9").removeClass("col-sm-9").addClass("col-sm-8");
							$thisrow.find(".col-sm-3").removeClass("col-sm-3").addClass("col-sm-4");
							return;
						};
						 if ($thisrow.find(".col-sm-8:nth-child(1)").length) {
						    $thisrow.find(".col-sm-8").removeClass("col-sm-8").addClass("col-sm-7");
							$thisrow.find(".col-sm-4").removeClass("col-sm-4").addClass("col-sm-5");
							return;
						};
						if ($thisrow.find(".col-sm-7:nth-child(1)").length) {
						    $thisrow.find(".col-sm-7").removeClass("col-sm-7").addClass("col-sm-6");
							$thisrow.find(".col-sm-5").removeClass("col-sm-5").addClass("col-sm-6");
							return;
						};
						if ($thisrow.find(".col-sm-6:nth-child(1)").length) {
						    $thisrow.find(".col-sm-6:nth-child(1)").removeClass("col-sm-6").addClass("col-sm-5");
							$thisrow.find(".col-sm-6:nth-child(2)").removeClass("col-sm-6").addClass("col-sm-7");
							return;
						};
						if ($thisrow.find(".col-sm-5:nth-child(1)").length) {
						    $thisrow.find(".col-sm-5").removeClass("col-sm-5").addClass("col-sm-4");
							$thisrow.find(".col-sm-7").removeClass("col-sm-7").addClass("col-sm-8");
							return;
						};
						if ($thisrow.find(".col-sm-4:nth-child(1)").length) {
						    $thisrow.find(".col-sm-4").removeClass("col-sm-4").addClass("col-sm-3");
							$thisrow.find(".col-sm-8").removeClass("col-sm-8").addClass("col-sm-9");
							return;
						};
						if ($thisrow.find(".col-sm-3:nth-child(1)").length) {
						    $thisrow.find(".col-sm-3").removeClass("col-sm-3").addClass("col-sm-2");
							$thisrow.find(".col-sm-9").removeClass("col-sm-9").addClass("col-sm-10");
							return;
						};
				    };
				};
         ...
         editor.addCommand("expandCMSColLeft", {
	     	exec: function(editor) {
		    	...
		    	if ($elem != null) {
				    ...
				    var $thisrow = $($elem).closest(".row");
				    if ($thisrow.find("div[class^='col-']").length == 2) { // Only two column layouts
					    if ($thisrow.find(".col-sm-2:nth-child(1)").length) {
						    $thisrow.find(".col-sm-2").removeClass("col-sm-2").addClass("col-sm-3");
							$thisrow.find(".col-sm-10").removeClass("col-sm-10").addClass("col-sm-9");
							return;
						};
						...
						if ($thisrow.find(".col-sm-6:nth-child(1)").length) {
						    $thisrow.find(".col-sm-6:nth-child(1)").removeClass("col-sm-6").addClass("col-sm-7");
							$thisrow.find(".col-sm-6:nth-child(2)").removeClass("col-sm-6").addClass("col-sm-5");
							return;
						};
						if ($thisrow.find(".col-sm-7:nth-child(1)").length) {
						    $thisrow.find(".col-sm-7").removeClass("col-sm-7").addClass("col-sm-8");
